...
- Nota historica: no reintroducir `slug` como campo de categorias o productos sin decision futura explicita, migracion y contrato nuevo. Las guias anteriores que mencionaban `slugify(name)` no representan un contrato vigente.
