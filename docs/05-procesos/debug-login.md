...
- `curl -i -H "content-type: application/json" -d '{"email":"${ADMIN_EMAIL}","password":"${ADMIN_PASSWORD}"}' http://localhost:3000/api/v1/auth/login` → 200 (token) o 401 con envelope claro.
