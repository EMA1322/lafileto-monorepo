...
| -------------------- | ---------------------------- | -------------------------------------------- | ------------------------------------- | ---------------------------- | ------------------------------------------------------ | ------------------------------------ | ----------------------------------------------------- |
| `#login`             | Login                        | `/src/components/login/login.html`           | `components/login/login.js`           | `/src/styles/login.css`      | Si ya hay auth, redirige a home permitido              | `pickHomeRoute()`                    | Medio: debe mantener redirect post-login y formulario |
| `#dashboard`         | Dashboard                    | `/src/components/dashboard/dashboard.html`   | `components/dashboard/dashboard.js`   | `/src/styles/dashboard.css`  | `canRead('dashboard')`                                 | Si no hay permiso, `#not-authorized` | Alto: dashboard + quick actions + Settings flag       |
